...
from utils.common import get_note_from_index, is_dominant_chord, parse_chord
...
def create_tritone_substitution_table(progression):
    """
    Analyse une progression et crée une table montrant la substitution
    tritonique pour chaque accord de dominante.
    """
    ...
    table_data = []
    headers = ["Chord", "Triton", "Shared notes"]

    for chord in progression:
        substitute, analysis = get_tritone_substitute(chord)
        table_data.append([chord, substitute, analysis])
